...
MediaPipe on-device → AI subject tracking, auto-framing
Built for India → low-cost, locally sourced components
```

My R&AI degree isn't just a degree — it's a portfolio advantage.
